...
import { useIsomorphicLayoutEffect, useOnClickOutside, useOnEscape, useRepositionOnResize, useTabbing } from './hooks';
...
export const Popup = forwardRef<PopupActions, PopupProps>(
    (
        ...
        const closePopup = (event?: React.SyntheticEvent | KeyboardEvent | TouchEvent | MouseEvent) => {
            if (!isOpen || disabled) return;
            setIsOpen(false);
