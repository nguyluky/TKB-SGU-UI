        ...
        >
            <motion.div className={cx('wrapper')}>
                <div className={cx('content')}>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tkb Sgu.
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to Tkb Sgu, accessible from{' '}
                                <a
                                    href="http://tkbsgusort.id.vn/"
                                    rel="external nofollow noopener noreferrer"
                                    target="_blank"
                                >
                                    http://tkbsgusort.id.vn/
                                </a>
                            </p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: nguyluky@gmail.com</li>
                    </ul>
                </div>
            </motion.div>
            <Footer />
